...
export class Step3Component implements OnInit,ControlValueAccessor,Validator {
  ...
  ngOnInit(): void {
    this.inBondFormStep3= this._formBuilder.group({
      ...
      svb_reference_date:[''],
      svb_load_assessable_value:['',[Validators.maxLength(10),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,3}$/),12)]],
      svb_load_on_duty:['',[Validators.maxLength(10),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,3}$/),12)]],
      ...
      invoice_value:['',[Validators.required,Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      ...
      discount_rate:['',[Validators.maxLength(6),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),6)]],
      discount_amount:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      hss_load_rate:['',[Validators.maxLength(6),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),6)]],
      hss_load_amount:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      freight_value:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      freight_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
      ...
      insurance_value:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      insurance_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
      insurance_currency:['',[Validators.maxLength(3),Validators.pattern("^[0-9a-zA-Z]+$")]],
      misc_charge:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      misc_currency:['',[Validators.maxLength(3),Validators.pattern("^[0-9a-zA-Z]+$")]],
      misc_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
      landing_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
      loading_charge:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      loading_currency:['',[Validators.maxLength(3),Validators.pattern("^[0-9a-zA-Z]+$")]],
      load_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
      agency_commission:['',[Validators.maxLength(16),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,2}$/),16)]],
      agency_commission_currency:['',[Validators.maxLength(3),Validators.pattern("^[0-9a-zA-Z]+$")]],
      agency_commission_rate:['',[Validators.maxLength(7),ValidatorsService.Decimalcheck((/^\d*\.?\d{0,4}$/),7)]],
