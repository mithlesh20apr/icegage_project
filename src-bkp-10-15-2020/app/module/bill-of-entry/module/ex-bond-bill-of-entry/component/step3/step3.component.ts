...
export class Step3Component implements OnInit {
  ...
  ngOnInit(): void {
    this.exBondFormStep3= this._formBuilder.group({
      ...
      country_of_origin_of_item:['',[Validators.maxLength(2),Validators.pattern("^[0-9a-zA-Z]+$")]],
      ...
      bcd_notification:['',[Validators.maxLength(10),Validators.pattern("^[0-9a-zA-Z]+$")]],
      bcd_notification_sr_no: ['',[Validators.maxLength(10),Validators.pattern("^[0-9a-zA-Z]+$")]],
      ...
      tariff_value_notification:['',[Validators.maxLength(10),Validators.pattern("^[0-9a-zA-Z]+$")]],
      ...
      address1_grower:['',[Validators.maxLength(70),Validators.pattern("^[0-9a-zA-Z]{1,}(\\W|\\s)\\d*\\s\\w{1,}\\s\\w+$")]],
      address2_grower:['',[Validators.maxLength(50),Validators.pattern("^[0-9a-zA-Z]{1,}(\\W|\\s)\\d*\\s\\w{1,}\\s\\w+$")]],
      ...
      pin_grower:['',[Validators.maxLength(10),Validators.pattern("[1-9]{1}[0-9]{9}")]],
      ...
      accessory_status:['',[Validators.maxLength(1),Validators.pattern("^[0-9a-zA-Z]+$]")]],
      ...
      constituent_serial_number:['',[Validators.required,Validators.maxLength(3),Validators.pattern("^[a-zA-Z]+$")]],
      ...
      production_batch_identifier:['',[Validators.required,Validators.maxLength(3),Validators.pattern("^[a-zA-Z]+$")]],
