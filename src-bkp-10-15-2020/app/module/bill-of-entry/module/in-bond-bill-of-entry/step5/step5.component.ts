...
export class Step5Component implements OnInit,ControlValueAccessor,Validator  {
  ...
  ngOnInit(): void {
    this.inBondFormStep5=this._formBuilder.group({
      ...
      invoice_serial_number_on:['',[Validators.required,Validators.maxLength(5),Validators.pattern("^[0-9]+$")]],
...
writeValue(val: any): void {
  ...
  val && this.inBondFormStep5.setValue(val, { emitEvent: false });
}
...
validate(c: AbstractControl): ValidationErrors | null{
 // console.log("Consignment Info validation", c);
  return this.inBondFormStep5.valid ? null : { invalidForm: {valid: false, message: "Step1 fields are invalid"}};
}
}
