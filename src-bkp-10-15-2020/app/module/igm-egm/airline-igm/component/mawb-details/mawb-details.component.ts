...
export class MawbDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.mawbDetails= this._formBuilder.group({
      ...
      uld_number:['',[ValidatorsService.alpaNumValidator,Validators.maxLength(15),Validators.required]],
      mawb_no:['',[ValidatorsService.alpaNumValidator,Validators.maxLength(20),Validators.required]],
      mawb_date:[''],
